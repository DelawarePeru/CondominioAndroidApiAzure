...
public class InmuebleDatamodel {
    ...
    public MutableLiveData<List<InmuebleListResponse>> getInmuListMutableLiveData() {
    ...
    public void requestListInmu(Integer idPersona, Integer idProyecto) {
        ...
        Call<PostResponse<InmuebleListResponse>> call = service.listInmueble(builJson(idPersona,idProyecto));
